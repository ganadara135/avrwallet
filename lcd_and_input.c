...
#define ACCEPT_PIN		6		// Port D block
...
unsigned long pre_timeC = 0;
unsigned long cur_timeC = 0;
//time_t current_time;
...
//Interrupt Service Routine for INT7  // Button  CANCEL
ISR(INT2_vect)
{
	cur_timeC = millis();
	if(abs(cur_timeC - pre_timeC) >= duration){
